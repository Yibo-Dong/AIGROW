"""
This is the main file to run the tool
it reads first the tool's arguments from the user and then executes the
code accordingly.
the main arguments are -bdd or -dnf
once one is chosen the corresponding code files are loaded and executed.
@author: msakr
"""
import argparse
import time
...
if __name__ == '__main__':
    ...
    print(toPrint)
    print("# Creation Date: " + datetime.datetime.now().strftime('%H:%M:%S on %A, %B the %dth, %Y'))
