"""
Given the ROBDDs table "bdd_tuple" this function will create the corresponding 
AIGs making use of the fact that a BDD can be seen as a network of multiplexers.
Then these AIGs are written in an AIGER file
@author: msakr
"""
import time
import sys
...
"""
This function creates new AND gate
and save it in the table "andGates"
this table contains triples of the form (ag el1 el2) 
where ag el1 ^ el2
"""
...
"""
Given a bdd_id this function extracts from bdd_tuple the corresponding
high low, then convert it to a multiplexer and creates the equivalen
AND gates
"""
...
"""
Given the "andGates" table (this table contains triples of the form (ag el1 el2) 
where ag el1 ^ el2), this function creates the corresponding AIGER file
