"""
This function generates for each latch a random number and generates for this
number the equivalent ROBDD as explained in the paper.
The ROBDD is saved in a table called "bdd_tuple" which contains all the
triples (bdd_id, high, low)
@author: msakr
"""
import time
import mpmath
...
"""
This function constructs the bdd in a top down fashion
and saves it in the table (or map bdd_tuple)
"""
...
mpmath.pretty = True
"""
Given a bdd_ID this function extracts its low and high children
as explained in the paper (they are extracted from the VRT table)
"""
